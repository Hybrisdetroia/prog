$(function() {
    ...
    function listarLanHouses(lanhouses) {
      ...
      for (var lanhouse of lanhouses) {
        linha = `<tr id="linha_${lanhouse.id}">
          ...
          <td>${lanhouse.computador.processador}</td>
          <td>${lanhouse.computador.ram}</td>
          <td>${lanhouse.computador.memoria}</td>
          <td>${lanhouse.computador.fonte}</td>
          <td>${lanhouse.usuario.nome}</td>
          <td>${lanhouse.usuario.idade}</td>
          <td>${lanhouse.usuario.email}</td>
          </tr>`;
  ...
  $(document).on("click", "#listarLanHouses", function() {
    exibirLanHouses();
  });
